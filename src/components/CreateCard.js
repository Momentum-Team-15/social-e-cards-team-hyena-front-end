    ...
    return (
        <section>
            ...
            <div className="columns is-flex is-justify-content-space-around">
                ...
                <ul className="ulbtn box menu">
                    <li className="menu-item">
                        <button className="btn button" onClick={()=>
                            {setColorOfBackground('#FFFFFF'); setOpen(false)}}>white</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button is-danger" onClick={()=>
                            {setColorOfBackground('#FF3860'); setOpen(false)}}>red</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button is-info" onClick={()=>
                            {setColorOfBackground('#209CEE'); setOpen(false)}}>blue</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button is-warning" onClick={()=>
                            {setColorOfBackground('#FFDD57'); setOpen(false)}}>yellow</button>
                    </li> 
                    <li className="menu-item">
                        <button className="btn button has-background-danger-light" onClick={()=>
                            {setColorOfBackground('#FEECF0'); setOpen(false)}}>pink</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button has-background-warning-light" onClick={()=>
                            {setColorOfBackground('#FFFBEB'); setOpen(false)}}>light yellow</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button has-background-info-light" onClick={()=>
                            {setColorOfBackground('#EEF6FC'); setOpen(false)}}>light blue</button>
                    </li>
                </ul>
                )}
                ...
                <ul className="ulbtn box menu">
                    <li className="menu-item">
                        <button className="btn button" style={{fontFamily: 'sans-serif'}} onClick={()=>
                            {setFamilyOfFont('sans-serif'); setOpen(false)}}>sans-serif</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button" style={{fontFamily: 'serif'}} onClick={()=>
                            {setFamilyOfFont('serif'); setOpen(false)}}>serif</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button" style={{fontFamily: 'monospace'}} onClick={()=>
                            {setFamilyOfFont('monospace'); setOpen(false)}}>monospace</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button" style={{fontFamily: 'cursive'}} onClick={()=>
                            {setFamilyOfFont('cursive'); setOpen(false)}}>cursive</button>
                    </li>
                    <li className="menu-item">
                        <button className="btn button" style={{fontFamily: 'fantasy'}} onClick={()=>
                            {setFamilyOfFont('fantasy'); setOpen(false)}}>fantasy</button>
                    </li>
                </ul>
                )}
                ...
                {open === 7 && (
                    <ul className="ulbtn box menu">
                        <li className="menu-item">
                            <button className="btn button" onClick={()=>
                                {setColorOfFont('black'); setOpen(false)}}>black</button>
                        </li>
                        <li className="menu-item">
                            <button className="btn button" onClick={()=>
                                {setColorOfFont('white'); setOpen(false)}}>white</button>
                        </li>
                        <li className="menu-item">
                            <button className="btn button" style={{color: '#CC0F35'}} onClick={()=>
                                {setColorOfFont('#CC0F35'); setOpen(false)}}>dark red</button>
                        </li>
                        <li className="menu-item">
                            <button className="btn button" style={{color: '#1D72AA'}} onClick={()=>
                                {setColorOfFont('#1D72AA'); setOpen(false)}}>dark blue</button>
                        </li>
                        <li className="menu-item">
                            <button className="btn button" style={{color: '#947600'}} onClick={()=>
                                {setColorOfFont('#947600'); setOpen(false)}}>dark yellow</button>
                        </li>
                    </ul>
                )}
